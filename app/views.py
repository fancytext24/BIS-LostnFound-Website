...
class ProductView(View):
    def get(self, request):
        ...
        pants_shorts = Product.objects.filter(category="PS")
        stationaries = Product.objects.filter(category="ST")
        bags = Product.objects.filter(category="BG")
        scrafs_hats_gloves = Product.objects.filter(category="SG")
        lunchboxes = Product.objects.filter(category="LB")
        waterbottles = Product.objects.filter(category="WB")
        valuables = Product.objects.filter(category="VB")
        ...
        return render(
            ...
            "app/home.html",
            {
                ...
                "bags": bags,
                "scrafs_hats_gloves": scrafs_hats_gloves,
...
def show_cart(request):
    if request.user.is_authenticated:
        ...
        return render(
            request,
            "app/addtocart.html",
            {"carts": cartt, "totalamount": totalamount, "amount": amount},
        )
...
def checkout(request):
    ...
    return render(
        request,
        "app/checkout.html",
        {"add": add, "totalamount": totalamount, "cartitems": cart_items},
    )
